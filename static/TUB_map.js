...
// Get properties from Data Layer to populate info window
  ...
  var picture = event.feature.getProperty('image');
  var picture_height = event.feature.getProperty('image_height')
// Create content for info window
var contentString = '<div id="infowindow">'+
'<h2 id="firstHeading" class="firstHeading">' + name + '</h2>'+
'<h3>' + description + '</h3>'+ '<div style="text-align: center">'+
'<img src= ' + picture  +' height='+picture_height +'/>'+
'</div>'+'</div>';
